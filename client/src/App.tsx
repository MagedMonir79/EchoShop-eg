...
import SellerRegisterPage from "@/pages/seller-register"; // Import Seller Registration Page
import SellerLearnMorePage from "@/pages/seller-learn-more"; // Import Seller Learn More Page
            ...
            <SupabaseAuthProvider>
              <AuthProvider>
                <Switch>
                  ...
                  />
                  <Route
                    path="/seller-learn-more"
                    component={SellerLearnMorePage}
                  />
                  ...
                  <Route
                    path="/firebase-simple-auth"
                    component={FirebaseSimpleAuthPage}
                  />
                  ...
                  <Route
                    path="/supabase-direct-test"
                    component={SupabaseDirectTestPage}
                  />
                  <Route
                    path="/supabase-health"
                    component={SupabaseHealthCheckPage}
                  />
                  <Route
                    path="/diagnostic"
                  ...
                  <Route
                    ...
                    component={DirectAdminLoginPage}
                  />

                  {/* صفحة تسجيل دخول المدير التجريبية - غير محمية */}
                  <Route
                    path="/admin/demo-login"
                    component={DemoAdminLoginPage}
                  />

                  {/* صفحة الحصول على رمز تفعيل المدير - غير محمية */}
                  <Route
                    path="/admin/get-activation-code"
                    component={SimpleActivationCodePage}
                  />

                  {/* لوحة تحكم المدير الجديدة */}
                  <Route
                    path="/admin/dashboard"
                    component={AdminDashboardNewPage}
                  />
                  ...
                  <ProtectedRoute
                    ...
                    component={AdminAddProductWithSupabase}
                    adminOnly
                  />
                  ...
                  <ProtectedRoute
                    ...
                    component={ManageCategoriesSupabasePage}
                    adminOnly
                  />
                  ...
                  <ProtectedRoute
                    ...
                    component={AdminSettingsThemePage}
                    adminOnly
                  />
                  <ProtectedRoute
                    path="/admin/settings/payment"
                    component={AdminSettingsPaymentPage}
                    adminOnly
                  />
                  <ProtectedRoute
                    path="/admin/settings/shipping"
                    component={AdminSettingsShippingPage}
                    adminOnly
                  />
...
export default App;
// Keep alive update on 27 May 2025
