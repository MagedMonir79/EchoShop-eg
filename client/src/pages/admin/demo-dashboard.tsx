...
export default function DemoDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <header className="bg-gray-800 shadow-md">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center">
            <h1 className="text-xl font-bold text-primary ml-2">لوحة تحكم المدير (وضع التجربة)</h1>
          </div>
          <div className="flex items-center">
            {user && (
      ...
      {/* شريط التنبيه للتجربة */}
      <div className="bg-yellow-600 text-black py-2 px-4 text-center text-sm">
        هذه نسخة تجريبية من لوحة التحكم تستخدم التخزين المحلي للمتصفح (localStorage) بدلاً من قاعدة البيانات.
      </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-gray-700 rounded-lg overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-600">
                  {activationCodes.filter(code => code.is_valid).length === 0 ? (
                    <tr>
                      <td colSpan={5} className="px-4 py-6 text-center text-gray-400">
                        لا توجد رموز تفعيل صالحة حالياً
                      </td>
                    </tr>
                  ) : (
                    activationCodes
